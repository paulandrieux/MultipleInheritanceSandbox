...
class GalleryController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeDemoBundle:Gallery')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeDemoBundle:Gallery:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeDemoBundle:Gallery')->find($id);
    ...
    */
     ...
     *
     * @Route("/{id}", name="gallery_update")
     * @Method("PUT")
     * @Template("AcmeDemoBundle:Gallery:edit.html.twig")
     */
