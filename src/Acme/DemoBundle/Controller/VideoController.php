...
use Acme\DemoBundle\Entity\Video;
use Acme\DemoBundle\Form\VideoType;
...
class VideoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('AcmeDemoBundle:Video')->findAll();
     ...
     * @Method("POST")
     * @Template("AcmeDemoBundle:Video:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('AcmeDemoBundle:Video')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("AcmeDemoBundle:Video:edit.html.twig")
     */
